...
import com.frozenproduction.taskmanager.dto.TaskStatsDto;
...
public class TaskController {
    ...
    @GetMapping("/stats")
    public ResponseEntity<TaskStatsDto> getMyStats() {
        Long userId = getCurrentUserId();
        return ResponseEntity.ok(taskService.getStatsForOwner(userId));
    }
